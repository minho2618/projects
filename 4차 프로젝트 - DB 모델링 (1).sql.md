...
ALTER TABLE `todo` ADD FOREIGN KEY (`mem_id`) REFERENCES `member` (`mem_id`);

ALTER TABLE `account` ADD FOREIGN KEY (`mem_id`) REFERENCES `member` (`mem_id`);

ALTER TABLE `health` ADD FOREIGN KEY (`mem_id`) REFERENCES `member` (`mem_id`);

ALTER TABLE `note` ADD FOREIGN KEY (`mem_id`) REFERENCES `member` (`mem_id`);
